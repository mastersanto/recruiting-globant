...
<div class="panel-display panel-1col clearfix" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  <div class="panel-panel panel-col">
    ...
    <section id="row1" class="glb-section hero" style="background-image: url('<?php print path_to_theme(); ?>/assets/hero_image.png');">
      <!--img src="<?php print path_to_theme(); ?>/assets/hero_image.png" /-->
