<h2 class="section-title"><?php print t('Testimonies') ?></h2>
<p class="section-subtitle"><?php print t('Meet our Globers and get to know what it’s 
like to work and have a  professional career at Globant!') ?></p>
